...
| ------ | -------------- | ------------------------------------------------------------------------------------------------------ |
| POST- INSERT   | /api/users     | Creates a user using the information sent inside the `request body`.                                   |
| GET - FIND   | /api/users     | Returns an array users.                                                                                |
| GET -findById   | /api/users/:id | Returns the user object with the specified `id`.                                                       |
| DELETE - REMOVE | /api/users/:id | Removes the user with the specified `id` and returns the deleted user.                                 |
| PUT  - update  | /api/users/:id | Updates the user with the specified `id` using data from the `request body`. Returns the modified user |
